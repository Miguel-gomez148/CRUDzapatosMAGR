<%-- 
    ...
    Created on : 5/07/2020, 08:00:52 PM
    Author     : Pc
--%>
<%-- 
...
<%
    try {
        ...
        branch.editaMarca(request.getParameter("marca"), id);%>
            <h2 class="p-3 mb-2 bg-success text-white">Se ha editado correctamente la marca</h2>
            <a class="btn btn-info btn-lg" href="marcas.jsp" role="button">Volver al inicio</a>
<%
} catch (Exception e) {
    out.print(e.getMessage());
%>
            <h2 class="p-3 mb-2 bg-danger text-white">No se ha editado correctamente la marca</h2>
